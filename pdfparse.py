...
def checkClause(filename):
    ...
    clauses['Amendments Clause (address needs updating)'] = "All amendments, additions or deletions to this document must be filed with the OASIS Center at oasis.center@berkeley.edu, or OASIS Center at 312 Eshleman Hall. "
    def diss(text):
